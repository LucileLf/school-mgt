...
const renderRow = (item: EventList) => (
  ...
  >
    ...
    <td>{new Intl.DateTimeFormat("fr-FR").format(item.startTime)}</td>
    <td className="hidden md:table-cell">{item.startTime.toLocaleTimeString("fr-FR", {hour: "2-digit", minute: "2-digit", hour12: false})}</td>
    <td className="hidden md:table-cell">{item.endTime.toLocaleTimeString("fr-FR", {hour: "2-digit", minute: "2-digit", hour12: false})}</td>
    <td>
